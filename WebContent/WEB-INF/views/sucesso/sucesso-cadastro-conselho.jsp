...
<head>
    ...
    <title>Plataforma Apoio aos Fundos | Conselho Cadastrado</title>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="alert alert-success text-justify">
                            <h4 class="alert-heading"><b>Conselho Cadastrado</b></h4>
                            <p>O cadastro do conselho foi realizado com sucesso.</p>
